...
<html lang="en">
  ...
  <body>
        ...
        <div class="row align-items-center">
          <div class="col-md-4">
            <div class="heading-wrap text-center element-animate">
              ...
              <h2 class="heading">Beautiful attractions</h2>
              <p class="mb-5">Our Hotel located at Klang, Selangor. We have all the attractions ready for you to explore alone or even with your family</p>
              <!--<p><a href="#" class="btn btn-primary btn-sm">More About Us</a></p>-->
            </div>
          </div>
          <div class="col-md-1"></div>
          <div class="col-md-7">
            <img src="images/f_img_1.jpg" width=120% alt="Image placeholder" class="img-md-fluid">
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="site-section bg-light" id="featuredrooms">
      <div class="container">
        <div class="row mb-5">
        ...
        <div class="row ">
          <div class="col-md-7">
            <div class="media d-block room mb-0">
              ...
              <div class="media-body">
                <h3 class="mt-0"><a href="#">Premier Room</a></h3>
                <ul class="room-specs">
                  <li><span class="ion-ios-people-outline"></span> 3-4 Guests</li>
          ...
          <div class="col-md-5 room-thumbnail-absolute">
            <a href="#" class="media d-block room bg first-room" style="background-image: url(images/img_4.jpg); ">
              <!-- <figure> -->
                <div class="overlap-text">
                  <span>
                    Deluxe Room 
            ...
            <a href="#" class="media d-block room bg second-room" style="background-image: url(images/img_2.jpg); ">
              <!-- <figure> -->
                <div class="overlap-text">
                  <span>
                    Standard Room 
      ...
      <div class="container">
        <div class="row justify-content-center align-items-center intro">
          <div class="col-md-9 text-center element-animate">
            ...
            <p class="lead mb-5">The desired rest awaits you in our hotel</p>
